        ...
        <Card className="bg-primary/5 border-none shadow-none">
          <CardContent className="pt-6">
            ...
            <p>
              ...
              (dados de 2021), a cidade é uma das mais vulneráveis às estiagens do Estado de São
              Paulo, com um histórico de seguidas crises hídricas. Tal problema provocou a
              perfuração de mais de 400 poços tubulares privados no Sistema Aquífero Bauru, que
              extraem 2,34 Mm³/ano, totalizando uma produção de água de 50,14 Mm³/ano para essa
              cidade. Essa vazão, ainda que fosse suficiente para o atendimento de toda a sua
              demanda, não o é devido a alguns fatores: 50% da água distribuída é perdida por fugas
              da rede e na própria estação de tratamento de água; há limitações na operação da rede
              que não é interligada; a captação do Batalha se faz em uma bacia pequena, com alta
              competição pela água (uso rural) e com sérios problemas no seu reservatório; e há
              regiões onde o Sistema Aquífero Guarani apresenta baixa produção. Assim, as razões que
              explicam as crises hídricas vão além da simples falha no suprimento das fontes de
              água.
            </p>
            <img
              className="absolute inset-0 z-0 bg-center bg-no-repeat brightness-110"
